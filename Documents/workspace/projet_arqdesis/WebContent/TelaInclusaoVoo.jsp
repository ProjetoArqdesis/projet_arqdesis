	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<div>&nbsp;</div>
				<div>&nbsp;</div>			
				<h2 class="content-head is-center">Cadastrar Vôo</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="incluir_voo.do"
						method="post">
						<fieldset>
							...
							<label>Origem</label> <input type="text" name="origem"
								placeholder="Origem" maxlength=100 required> 
							<label>Destino</label> <input type="text" name="destino"
								placeholder="Destino" maxlength=100 required> 
							<label>Escala</label> <input type="text" name="escala"
								placeholder="Escala" maxlength=100 required> 
							<label>Data</label> <input type="text" name="data_voo"
								placeholder="Data do Vôo" maxlength=14 required> 
							<label>Hora</label> <input type="text" name="hora"
								placeholder="Hora" maxlength=100 required> 
							<label>Tipo de Aeronave</label> <select style="width:300px" name="tipo_aeronave"></select>
							<label>Situação</label> <input type="text" name="situacao"
								placeholder="Situação" maxlength=100 required> 
							<label>Preço</label> <input type="text" name="preco"
								placeholder="Preço" maxlength=100 required> 
								<%
