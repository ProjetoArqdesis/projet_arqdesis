		...
		<div class="content">
			...
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="incluir_cliente.do"
						method="post">
						<fieldset>
							<label>Nome</label> <input type="text" name="nome"
								placeholder="Primeiro Nome" maxlength=100 required> 
							<label>Sobrenome</label> <input type="text" name="sobrenome"
								placeholder="Sobrenome" maxlength=100 required> 
							...
							<label>Telefone Celular</label> <input type="text" name="celular"
								placeholder="Telefone Celular" maxlength=15 required> 
							...
							<label>Tipo de Passageiro</label> <input type="text" name="tipo_passageiro"
								placeholder="Tipo de Passageiro" maxlength=100 required> 
							<label>Forma de Tratamento</label> <input type="text" name="forma_tratamento"
								placeholder="Forma de Tratamento" maxlength=100 required> 
								<%
