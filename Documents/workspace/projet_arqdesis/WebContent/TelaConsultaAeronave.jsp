	...
	<div class="content-wrapper">
		<div class="content">
			<div class="content">
				<div>&nbsp;</div>
				<div>&nbsp;</div>
				<h2 class="content-head is-center">Consultar Aeronave</h2>
			</div>
			<div class="pure-g">
				<div class="l-box-lrg pure-u-1">
					<form class="pure-form pure-form-stacked" action="consultar_aeronave.do"
						method="post">
						<fieldset>
							...
							<label>Nome</label> <input type="text" name="nome_aeronave"
								placeholder="Nome da Aeronave" maxlength=100 required disabled> 
							<label>Quantidade de Assentos</label> <input type="number" name="qtd_assentos"
								placeholder="Quantidade de Assentos" maxlength=100 required disabled> 
							<label>Tipo</label> <input type="text" name="tipo"
								placeholder="Tipo" maxlength=100 required disabled>
								<%
